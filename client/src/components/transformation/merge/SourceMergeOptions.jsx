  ...
  return (
    <div>
      ...
      <SelectColumn
        ...
        // options={columnSelectSelectedOption(intl, columns)}
        columns={columns}
        value={mergeColumn}
       // intl={intl}
        // value={columnSelectOptions(mergeColumn, columns)}
        onChange={onChange}
      />
    </div>
  );
      ...
      <div className="aggregationContainer">
        <span className="aggregationColumn">
          <SelectMenu
            ...
            value={columnSelectSelectedOption(aggregationColumn, dataset.get('columns'))}
            intl={intl}
...
function SelectMergeColumns({ onChange, onChangeAll, columns, selected, intl }) {
